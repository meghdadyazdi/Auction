...
class TestToDoOrderForm(TestCase):
    ...
    def test_can_creat_an_Order(self):
        form = OrderForm({'full_name': 'Meghdad Y',
                          'phone_number': '0046 88888888', 'country': "Sweden",
